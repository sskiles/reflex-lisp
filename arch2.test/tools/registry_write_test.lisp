;;;; Test execute-tool with protocol classes

(defpackage #:harness.tools.registry.testwrite
  (:use #:cl #:harness.tools.protocol))
(in-package #:harness.tools.registry.testwrite)
...
(format t "~&[harness.tools.registry.testwrite] Loaded~%")